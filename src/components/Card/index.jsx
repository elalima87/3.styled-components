...
import { UserPicture } from '../Header/styles'
...
const Card = () => {
  return (
    <CardContainer>
        ...
        <Content>
            <UserInfo>
                <UserPicture src="https://avatars.githubusercontent.com/u/6643122?v=4" alt="Foto do usuário" />
                <div>
                    <h4>Rafaela Lima</h4>
                    <p>Há 3 minutos</p>
                </div>
